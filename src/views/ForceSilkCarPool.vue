<template>
    <div id="app">
        ...
        <van-button type="danger" block hairline="hairline" v-if="this.showButton"
                    style="margin:  0;overflow: hidden ;display: inline" @click="dingDeng">强制拼车
        </van-button>
              ...
              // this.getSilks()
                ...
                this.$api.getSilkss(code).then((res) => {
                    if (res.data.status === '200') {
                        ...
                        if(this.data.silkCarRowColList.length>0&&this.data.forceCarPlooing){
